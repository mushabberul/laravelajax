            ...
            <div class="modal-body">
                <form action="" method="post">
                    <div class="row">
                        ...
                        <x-text-input col='col-md-6' name='post_code' labelName='Enter you post code' type='number'
                            placeholder='Ex:7610' />
                            ...
                            <x-select-input col='col-md-6' name='upozila_id' labelName='Upozila' />
                        <x-text-input col='col-md-6' name='password' labelName='Password' type='password'
                            placeholder='Ex: Uttora 18,Dhaka,Bangladesh' />
